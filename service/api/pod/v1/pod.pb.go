...
var file_pod_v1_pod_proto_rawDesc = []byte{
	...
	0x0f, 0x0a, 0x0d, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x22, 0x10, 0x0a, 0x0e, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x32, 0xad, 0x01, 0x0a, 0x0a, 0x45, 0x63, 0x69, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_pod_v1_pod_proto_goTypes = []any{
	...
	(*Container)(nil),      // 3: pod.Container
	(*SavePodResp)(nil),    // 4: pod.SavePodResp
	(*EciVNode)(nil),       // 5: pod.EciVNode
	(*SaveVNodeResp)(nil),  // 6: pod.SaveVNodeResp
	(*NotifyRequest)(nil),  // 7: pod.NotifyRequest
	(*NotifyResponse)(nil), // 8: pod.NotifyResponse
}
var file_pod_v1_pod_proto_depIdxs = []int32{
	1, // 0: pod.EciPod.Pod:type_name -> pod.Pod
	2, // 1: pod.Pod.network:type_name -> pod.NetworkInfo
	3, // 2: pod.Pod.Containers:type_name -> pod.Container
	0, // 3: pod.EciService.SavePod:input_type -> pod.EciPod
	5, // 4: pod.EciService.SaveVNode:input_type -> pod.EciVNode
	7, // 5: pod.EciService.SendUserNotification:input_type -> pod.NotifyRequest
	4, // 6: pod.EciService.SavePod:output_type -> pod.SavePodResp
	6, // 7: pod.EciService.SaveVNode:output_type -> pod.SaveVNodeResp
	8, // 8: pod.EciService.SendUserNotification:output_type -> pod.NotifyResponse
