...
var file_agent_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x10, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x01, 0x32, 0xb9, 0x07,
...
var file_agent_proto_goTypes = []any{
	...
	nil,                              // 29: agent.NodeRequest.IpPoolSegmentsEntry
	nil,                              // 30: agent.NodeRequest.LabelsEntry
	nil,                              // 31: agent.NodeRequest.ProductQuantityEntry
	(*v1.ConfigMap)(nil),             // 32: k8s.io.api.core.v1.ConfigMap
	(*v1.ConfigMapVolumeSource)(nil), // 33: k8s.io.api.core.v1.ConfigMapVolumeSource
	(*v1.Secret)(nil),                // 34: k8s.io.api.core.v1.Secret
	(*v1.SecretVolumeSource)(nil),    // 35: k8s.io.api.core.v1.SecretVolumeSource
	(*v1.Pod)(nil),                   // 36: k8s.io.api.core.v1.Pod
	(*v1.Taint)(nil),                 // 37: k8s.io.api.core.v1.Taint
	(*v1.ResourceQuotaSpec)(nil),     // 38: k8s.io.api.core.v1.ResourceQuotaSpec
	(*v1.ResourceQuotaStatus)(nil),   // 39: k8s.io.api.core.v1.ResourceQuotaStatus
}
var file_agent_proto_depIdxs = []int32{
	32, // 0: agent.ConfigMapVolume.source:type_name -> k8s.io.api.core.v1.ConfigMap
	33, // 1: agent.ConfigMapVolume.volume:type_name -> k8s.io.api.core.v1.ConfigMapVolumeSource
	34, // 2: agent.SecretVolume.source:type_name -> k8s.io.api.core.v1.Secret
	35, // 3: agent.SecretVolume.volume:type_name -> k8s.io.api.core.v1.SecretVolumeSource
	1,  // 4: agent.Pod.network:type_name -> agent.NetworkInfo
	36, // 5: agent.Pod.rawPod:type_name -> k8s.io.api.core.v1.Pod
	5,  // 6: agent.PodRequest.pods:type_name -> agent.Pod
	34, // 7: agent.PodRequest.secrets:type_name -> k8s.io.api.core.v1.Secret
	32, // 8: agent.PodRequest.configMaps:type_name -> k8s.io.api.core.v1.ConfigMap
	0,  // 9: agent.PodResponse.code:type_name -> agent.ActionCode
	1,  // 10: agent.Pods.network:type_name -> agent.NetworkInfo
	36, // 11: agent.Pods.pod:type_name -> k8s.io.api.core.v1.Pod
	...
	29, // 15: agent.NodeRequest.ip_pool_segments:type_name -> agent.NodeRequest.IpPoolSegmentsEntry
	14, // 16: agent.NodeRequest.private_net:type_name -> agent.PrivateNet
	37, // 17: agent.NodeRequest.Taints:type_name -> k8s.io.api.core.v1.Taint
	30, // 18: agent.NodeRequest.labels:type_name -> agent.NodeRequest.LabelsEntry
	31, // 19: agent.NodeRequest.productQuantity:type_name -> agent.NodeRequest.ProductQuantityEntry
	...
	38, // 25: agent.QuotaSetRequest.quota:type_name -> k8s.io.api.core.v1.ResourceQuotaSpec
	39, // 26: agent.QuotaStatusResponse.quota:type_name -> k8s.io.api.core.v1.ResourceQuotaStatus
	...
	9,  // 44: agent.Agent.CreatePod:output_type -> agent.PodResponse
	9,  // 45: agent.Agent.UpdatePod:output_type -> agent.PodResponse
	9,  // 46: agent.Agent.DeletePod:output_type -> agent.PodResponse
	9,  // 47: agent.Agent.RebootPod:output_type -> agent.PodResponse
	12, // 48: agent.Agent.GetPod:output_type -> agent.PodInfoResponse
	12, // 49: agent.Agent.GetPods:output_type -> agent.PodInfoResponse
	12, // 50: agent.Agent.GetPodStatus:output_type -> agent.PodInfoResponse
	28, // 51: agent.Agent.CheckResourceQuota:output_type -> agent.QuotaResponse
	27, // 52: agent.Agent.GetResourceQuota:output_type -> agent.QuotaStatusResponse
	28, // 53: agent.Agent.SetResourceQuota:output_type -> agent.QuotaResponse
	19, // 54: agent.Agent.CreateNode:output_type -> agent.NodeResponse
	19, // 55: agent.Agent.UpdateNode:output_type -> agent.NodeResponse
	19, // 56: agent.Agent.DeleteNode:output_type -> agent.NodeResponse
	21, // 57: agent.Agent.GetNodeGpuUsage:output_type -> agent.NodeGpuUsageResponse
	24, // 58: agent.Agent.CreateWsToken:output_type -> agent.CreateWsTokenResponse
