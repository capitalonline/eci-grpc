...
var file_agent_proto_rawDesc = []byte{
	...
	0x47, 0x6f, 0x10, 0x02, 0x32, 0x8f, 0x09, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x34,
...
var file_agent_proto_depIdxs = []int32{
	...
	7,  // 39: agent.Agent.CheckResourceQuota:input_type -> agent.PodRequest
	29, // 40: agent.Agent.GetResourceQuota:input_type -> agent.QuotaRequest
	29, // 41: agent.Agent.SetResourceQuota:input_type -> agent.QuotaRequest
	19, // 42: agent.Agent.CreateNode:input_type -> agent.NodeRequest
	19, // 43: agent.Agent.UpdateNode:input_type -> agent.NodeRequest
	19, // 44: agent.Agent.DeleteNode:input_type -> agent.NodeRequest
	21, // 45: agent.Agent.GetNodeGpuUsage:input_type -> agent.NodeGpuUsageRequest
	22, // 46: agent.Agent.GetNodeUsage:input_type -> agent.NodeUsageRequest
	27, // 47: agent.Agent.CreateWsToken:input_type -> agent.CreateWsTokenRequest
	32, // 48: agent.Agent.GetECIInstances:input_type -> agent.GetInstanceRequest
	34, // 49: agent.Agent.UpdatePriceRange:input_type -> agent.PriceRangeRequest
	10, // 50: agent.Agent.CreatePod:output_type -> agent.PodResponse
	10, // 51: agent.Agent.UpdatePod:output_type -> agent.PodResponse
	10, // 52: agent.Agent.DeletePod:output_type -> agent.PodResponse
	10, // 53: agent.Agent.RebootPod:output_type -> agent.PodResponse
	13, // 54: agent.Agent.GetPod:output_type -> agent.PodInfoResponse
	13, // 55: agent.Agent.GetPods:output_type -> agent.PodInfoResponse
	13, // 56: agent.Agent.GetPodStatus:output_type -> agent.PodInfoResponse
	31, // 57: agent.Agent.CheckResourceQuota:output_type -> agent.QuotaResponse
	30, // 58: agent.Agent.GetResourceQuota:output_type -> agent.QuotaStatusResponse
	31, // 59: agent.Agent.SetResourceQuota:output_type -> agent.QuotaResponse
	20, // 60: agent.Agent.CreateNode:output_type -> agent.NodeResponse
	20, // 61: agent.Agent.UpdateNode:output_type -> agent.NodeResponse
	20, // 62: agent.Agent.DeleteNode:output_type -> agent.NodeResponse
	23, // 63: agent.Agent.GetNodeGpuUsage:output_type -> agent.NodeGpuUsageResponse
	25, // 64: agent.Agent.GetNodeUsage:output_type -> agent.NodeUsageResponse
	28, // 65: agent.Agent.CreateWsToken:output_type -> agent.CreateWsTokenResponse
	33, // 66: agent.Agent.GetECIInstances:output_type -> agent.GetInstanceResponse
	35, // 67: agent.Agent.UpdatePriceRange:output_type -> agent.PriceRangeResponse
