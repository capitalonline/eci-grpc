...
type QuotaResponse struct {
	...
	Quota *v1.ResourceQuota `protobuf:"bytes,1,opt,name=quota,proto3,oneof" json:"quota,omitempty"`
}
...
func (x *QuotaResponse) GetQuota() *v1.ResourceQuota {
	if x != nil {
		return x.Quota
	}
	return nil
...
var file_agent_proto_rawDesc = []byte{
	...
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x46, 0x0a, 0x0c, 0x51, 0x75, 0x6f, 0x74, 0x61, 0x52,
	...
	0x3c, 0x0a, 0x05, 0x71, 0x75, 0x6f, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21,
	0x2e, 0x6b, 0x38, 0x73, 0x2e, 0x69, 0x6f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x72, 0x65,
	0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x51, 0x75, 0x6f, 0x74,
	0x61, 0x48, 0x00, 0x52, 0x05, 0x71, 0x75, 0x6f, 0x74, 0x61, 0x88, 0x01, 0x01, 0x42, 0x08, 0x0a,
	0x06, 0x5f, 0x71, 0x75, 0x6f, 0x74, 0x61, 0x2a, 0x34, 0x0a, 0x0a, 0x41, 0x63, 0x74, 0x69, 0x6f,
	...
	0x64, 0x65, 0x10, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x01, 0x32, 0xab, 0x06,
...
var file_agent_proto_goTypes = []any{
	...
	nil,                              // 27: agent.NodeRequest.IpPoolSegmentsEntry
	nil,                              // 28: agent.NodeRequest.LabelsEntry
	nil,                              // 29: agent.NodeRequest.ProductQuantityEntry
	(*v1.ConfigMap)(nil),             // 30: k8s.io.api.core.v1.ConfigMap
	(*v1.ConfigMapVolumeSource)(nil), // 31: k8s.io.api.core.v1.ConfigMapVolumeSource
	(*v1.Secret)(nil),                // 32: k8s.io.api.core.v1.Secret
	(*v1.SecretVolumeSource)(nil),    // 33: k8s.io.api.core.v1.SecretVolumeSource
	(*v1.Pod)(nil),                   // 34: k8s.io.api.core.v1.Pod
	(*v1.Taint)(nil),                 // 35: k8s.io.api.core.v1.Taint
	(*v1.ResourceQuota)(nil),         // 36: k8s.io.api.core.v1.ResourceQuota
}
var file_agent_proto_depIdxs = []int32{
	30, // 0: agent.ConfigMapVolume.source:type_name -> k8s.io.api.core.v1.ConfigMap
	31, // 1: agent.ConfigMapVolume.volume:type_name -> k8s.io.api.core.v1.ConfigMapVolumeSource
	32, // 2: agent.SecretVolume.source:type_name -> k8s.io.api.core.v1.Secret
	33, // 3: agent.SecretVolume.volume:type_name -> k8s.io.api.core.v1.SecretVolumeSource
	1,  // 4: agent.Pod.network:type_name -> agent.NetworkInfo
	34, // 5: agent.Pod.rawPod:type_name -> k8s.io.api.core.v1.Pod
	5,  // 6: agent.PodRequest.pods:type_name -> agent.Pod
	32, // 7: agent.PodRequest.secrets:type_name -> k8s.io.api.core.v1.Secret
	30, // 8: agent.PodRequest.configMaps:type_name -> k8s.io.api.core.v1.ConfigMap
	0,  // 9: agent.PodResponse.code:type_name -> agent.ActionCode
	1,  // 10: agent.Pods.network:type_name -> agent.NetworkInfo
	34, // 11: agent.Pods.pod:type_name -> k8s.io.api.core.v1.Pod
	...
	27, // 15: agent.NodeRequest.ip_pool_segments:type_name -> agent.NodeRequest.IpPoolSegmentsEntry
	14, // 16: agent.NodeRequest.private_net:type_name -> agent.PrivateNet
	35, // 17: agent.NodeRequest.Taints:type_name -> k8s.io.api.core.v1.Taint
	28, // 18: agent.NodeRequest.labels:type_name -> agent.NodeRequest.LabelsEntry
	29, // 19: agent.NodeRequest.productQuantity:type_name -> agent.NodeRequest.ProductQuantityEntry
	...
	36, // 25: agent.QuotaResponse.quota:type_name -> k8s.io.api.core.v1.ResourceQuota
	...
	25, // 35: agent.Agent.GetResourceQuota:input_type -> agent.QuotaRequest
	18, // 36: agent.Agent.CreateNode:input_type -> agent.NodeRequest
	18, // 37: agent.Agent.UpdateNode:input_type -> agent.NodeRequest
	18, // 38: agent.Agent.DeleteNode:input_type -> agent.NodeRequest
	20, // 39: agent.Agent.GetNodeGpuUsage:input_type -> agent.NodeGpuUsageRequest
	23, // 40: agent.Agent.CreateWsToken:input_type -> agent.CreateWsTokenRequest
	9,  // 41: agent.Agent.CreatePod:output_type -> agent.PodResponse
	9,  // 42: agent.Agent.UpdatePod:output_type -> agent.PodResponse
	9,  // 43: agent.Agent.DeletePod:output_type -> agent.PodResponse
	9,  // 44: agent.Agent.RebootPod:output_type -> agent.PodResponse
	12, // 45: agent.Agent.GetPod:output_type -> agent.PodInfoResponse
	12, // 46: agent.Agent.GetPods:output_type -> agent.PodInfoResponse
	12, // 47: agent.Agent.GetPodStatus:output_type -> agent.PodInfoResponse
	26, // 48: agent.Agent.GetResourceQuota:output_type -> agent.QuotaResponse
	19, // 49: agent.Agent.CreateNode:output_type -> agent.NodeResponse
	19, // 50: agent.Agent.UpdateNode:output_type -> agent.NodeResponse
	19, // 51: agent.Agent.DeleteNode:output_type -> agent.NodeResponse
	21, // 52: agent.Agent.GetNodeGpuUsage:output_type -> agent.NodeGpuUsageResponse
	24, // 53: agent.Agent.CreateWsToken:output_type -> agent.CreateWsTokenResponse
