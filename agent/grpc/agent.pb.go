...
var file_agent_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x08, 0x73, 0x74, 0x61, 0x72, 0x74, 0x45, 0x6e, 0x64, 0x22, 0xc2, 0x01, 0x0a, 0x0b,
	...
	0x65, 0x2a, 0x34, 0x0a, 0x0a, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x64, 0x65, 0x12,
	...
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x01, 0x32, 0xda, 0x02, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e,
...
var file_agent_proto_depIdxs = []int32{
	...
	0,  // 12: agent.NodeResponse.code:type_name -> agent.ActionCode
	11, // 13: agent.Agent.CreatePod:input_type -> agent.PodRequest
	11, // 14: agent.Agent.UpdatePod:input_type -> agent.PodRequest
	12, // 15: agent.Agent.DeletePod:input_type -> agent.PodDeleteRequest
	15, // 16: agent.Agent.CreateNode:input_type -> agent.NodeRequest
	15, // 17: agent.Agent.UpdateNode:input_type -> agent.NodeRequest
	15, // 18: agent.Agent.DeleteNode:input_type -> agent.NodeRequest
	13, // 19: agent.Agent.CreatePod:output_type -> agent.PodResponse
	13, // 20: agent.Agent.UpdatePod:output_type -> agent.PodResponse
	13, // 21: agent.Agent.DeletePod:output_type -> agent.PodResponse
	16, // 22: agent.Agent.CreateNode:output_type -> agent.NodeResponse
	16, // 23: agent.Agent.UpdateNode:output_type -> agent.NodeResponse
	16, // 24: agent.Agent.DeleteNode:output_type -> agent.NodeResponse
