...
func (c *agentClient) GetResourceQuota(ctx context.Context, in *QuotaRequest, opts ...grpc.CallOption) (*QuotaStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *agentClient) SetResourceQuota(ctx context.Context, in *QuotaRequest, opts ...grpc.CallOption) (*QuotaResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QuotaResponse)
...
func (c *agentClient) GetECIInstances(ctx context.Context, in *GetInstanceRequest, opts ...grpc.CallOption) (*GetInstanceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetInstanceResponse)
	err := c.cc.Invoke(ctx, Agent_GetECIInstances_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) CreateDataCache(ctx context.Context, in *DataCacheRequest, opts ...grpc.CallOption) (*DataCacheResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DataCacheResponse)
	err := c.cc.Invoke(ctx, Agent_CreateDataCache_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) DeleteDataCache(ctx context.Context, in *DataCacheRequest, opts ...grpc.CallOption) (*DataCacheResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DataCacheResponse)
	err := c.cc.Invoke(ctx, Agent_DeleteDataCache_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAgentServer) GetResourceQuota(context.Context, *QuotaRequest) (*QuotaStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetResourceQuota not implemented")
}
func (UnimplementedAgentServer) SetResourceQuota(context.Context, *QuotaRequest) (*QuotaResponse, error) {
...
func (UnimplementedAgentServer) DeleteDataCache(context.Context, *DataCacheRequest) (*DataCacheResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteDataCache not implemented")
}
...
func _Agent_CheckResourceQuota_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PodRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServer).CheckResourceQuota(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Agent_CheckResourceQuota_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServer).CheckResourceQuota(ctx, req.(*PodRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Agent_SetResourceQuota_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServer).SetResourceQuota(ctx, req.(*QuotaRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Agent_GetECIInstances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetInstanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServer).GetECIInstances(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Agent_GetECIInstances_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServer).GetECIInstances(ctx, req.(*GetInstanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Agent_CreateDataCache_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DataCacheRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServer).CreateDataCache(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Agent_CreateDataCache_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServer).CreateDataCache(ctx, req.(*DataCacheRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Agent_DeleteDataCache_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DataCacheRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServer).DeleteDataCache(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Agent_DeleteDataCache_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServer).DeleteDataCache(ctx, req.(*DataCacheRequest))
	}
	return interceptor(ctx, in, info, handler)
}
